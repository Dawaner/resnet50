...
class ResnetBlock(tf.keras.Model):
    ...
    def __init__(self, filters, strides=1, residual_path=False):
        ...
        self.c1 = tf.keras.layers.Conv2D(filters, (1, 1), strides=strides, padding='same', use_bias=False)
        ...
        self.c3 = tf.keras.layers.Conv2D(filters * 4, (1, 1), strides=1, padding='same', use_bias=False)
        self.b3 = tf.keras.layers.BatchNormalization()

        self.down_c1 = tf.keras.layers.Conv2D(filters * 4, (1, 1), strides=strides, padding='same', use_bias=False)
